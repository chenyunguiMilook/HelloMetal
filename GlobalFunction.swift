...
public func calculateUVTransform(frameBufferSize: CGSize, zoomRect: CGRect, mirror: MGLMirror, rotation: MGLRotation) -> CGAffineTransform {
...
public func getUVTransformForFlippedVertically() -> CGAffineTransform {
    return MGLMirror.vertical.mirror(aroundCenter: CGPoint(x: 0.5, y: 0.5))
}

private func getUVTransform(zoomRect: CGRect, mirror: MGLMirror, rotation: MGLRotation) -> CGAffineTransform {
